...
def generate_launch_description():
    ...
    pkg_flexy_description = FindPackageShare('flexy_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_flexy_description, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the flexy_description package
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'flexy_description',
