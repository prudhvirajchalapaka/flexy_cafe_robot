...
def generate_launch_description():
    ...
    pkg_flexy_slam = get_package_share_directory('flexy_slam')

    gazebo_models_path, ignore_last_dir = os.path.split(pkg_flexy_slam)
    ...
    slam_toolbox_params_path = os.path.join(
        get_package_share_directory('flexy_slam'),
        'config',
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([pkg_flexy_slam, 'rviz', LaunchConfiguration('rviz_config')])],
