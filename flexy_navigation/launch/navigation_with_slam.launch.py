...
def generate_launch_description():
    ...
    pkg_slamtoolbox = get_package_share_directory('flexy_slam')

    gazebo_models_path, ignore_last_dir = os.path.split(pkg_flexy_navigation)
    ...
    navigation_params_path = os.path.join(
        get_package_share_directory('flexy_navigation'),
        'config',
        'navigation.yaml'
    )
